...
export function outsourcedIssueItemMeta(): ResourceMeta {
  return {
    ...
    fields: [
      ...
      f('base_qty', 'baseQty', 'decimal', '折算数量(材料默认单位,6 位)', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_code', 'materialCode', 'string', '物料编号', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_name', 'materialName', 'string', '物料名称', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_spec', 'materialSpec', 'string', '规格', {"sortable": true, "filterable": true, "readonly": true}),
      f('unit_name', 'unitName', 'string', '单位名称', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_no', 'orderNo', 'string', '订单号', {"sortable": true, "filterable": true, "readonly": true}),
      ...
      f('material_id', 'materialId', 'fk', '材料(以发料清单行为准)', {"filterable": true, "ref": {"resource": "invMaterials", "relation": "material", "labelField": "name"}, "readonly": true}),
      f('unit_id', 'unitId', 'fk', '单位(以发料清单行为准)', {"filterable": true, "ref": {"resource": "basUnits", "relation": "unit", "labelField": "name"}, "readonly": true}),
      ...
      f('issue_no', 'issueNo', 'string', '发料单号', {"readonly": true, "calculated": true, "sortable": true, "filterable": true}),
      f('issue_date', 'issueDate', 'date', '发料日期', {"readonly": true, "calculated": true, "sortable": true, "filterable": true}),
      f('issue_status', 'issueStatus', 'enum', '发料单状态', {"readonly": true, "calculated": true, "sortable": true, "filterable": true, "enumOptions": [{"label": "草稿", "value": "DRAFT"}, {"label": "已审核", "value": "AUDITED"}, {"label": "已作废", "value": "VOIDED"}]}),
...
export function outsourcedReceiptItemMeta(): ResourceMeta {
  return {
    ...
    fields: [
      ...
      f('idx', 'idx', 'integer', '行号', {"sortable": true, "filterable": true}),
      f('qty', 'qty', 'decimal', '录入数量', {"sortable": true, "filterable": true}),
      f('base_qty', 'baseQty', 'decimal', '折算数量(物料默认单位,6 位)', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_code', 'materialCode', 'string', '物料编号', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_name', 'materialName', 'string', '物料名称', {"sortable": true, "filterable": true, "readonly": true}),
      f('material_spec', 'materialSpec', 'string', '规格', {"sortable": true, "filterable": true, "readonly": true}),
      f('customer_part_no', 'customerPartNo', 'string', '客户料号', {"sortable": true, "filterable": true, "readonly": true}),
      f('unit_name', 'unitName', 'string', '单位名称', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_no', 'orderNo', 'string', '订单号', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_qty', 'orderQty', 'decimal', '订购数量(订单行单位)', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_base_qty', 'orderBaseQty', 'decimal', '订购数量(默认单位)', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_unit_name', 'orderUnitName', 'string', '订单行单位名称', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_price', 'orderPrice', 'decimal', '原币含税单价(加工费)', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_amount', 'orderAmount', 'decimal', '原币含税金额', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_base_price', 'orderBasePrice', 'decimal', '本币含税单价(加工费)', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_base_amount', 'orderBaseAmount', 'decimal', '本币含税金额', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_tax_rate', 'orderTaxRate', 'decimal', '税率', {"sortable": true, "filterable": true, "readonly": true}),
      f('order_currency_code', 'orderCurrencyCode', 'string', '订单原币代码', {"sortable": true, "filterable": true, "readonly": true}),
      f('reconciled_qty', 'reconciledQty', 'decimal', '已对账数量(默认单位;由采购对账单生效/回退同步)', {"sortable": true, "filterable": true, "readonly": true}),
      f('remarks', 'remarks', 'string', '行备注', {"sortable": true, "filterable": true}),
      f('inserted_at', 'insertedAt', 'datetime', '创建时间', {"sortable": true, "filterable": true}),
      f('updated_at', 'updatedAt', 'datetime', '更新时间', {"sortable": true, "filterable": true}),
      ...
      f('material_id', 'materialId', 'fk', '物料(成品,须与订单条目一致)', {"filterable": true, "ref": {"resource": "invMaterials", "relation": "material", "labelField": "name"}, "readonly": true}),
      ...
      f('receipt_no', 'receiptNo', 'string', '入库单号', {"readonly": true, "calculated": true, "sortable": true, "filterable": true}),
      f('receipt_date', 'receiptDate', 'date', '入库日期', {"readonly": true, "calculated": true, "sortable": true, "filterable": true}),
      f('receipt_status', 'receiptStatus', 'enum', '入库单状态', {"readonly": true, "calculated": true, "sortable": true, "filterable": true, "enumOptions": [{"label": "草稿", "value": "DRAFT"}, {"label": "已审核", "value": "AUDITED"}, {"label": "已作废", "value": "VOIDED"}]}),
      f('party_type', 'partyType', 'enum', '对手类型(供应商/内部公司)', {"readonly": true, "calculated": true, "sortable": true, "filterable": true, "enumOptions": [{"label": "供应商", "value": "SUPPLIER"}, {"label": "客户", "value": "CUSTOMER"}, {"label": "内部公司", "value": "COMPANY"}, {"label": "员工", "value": "EMPLOYEE"}]}),
      f('party_id', 'partyId', 'fk', '对手', {"readonly": true, "calculated": true, "filterable": true, "ref": {"resource": null, "relation": null, "labelField": null, "discriminator": "partyType", "discriminatorType": "enum", "variants": [{"label": "内部公司", "labelField": "name", "resource": "basCompanies", "value": "COMPANY"}, {"label": "供应商", "labelField": "name", "resource": "purSuppliers", "value": "SUPPLIER"}]}}),
...
export function outsourcedReceiptItemByproductMeta(): ResourceMeta {
  return {
    ...
    fields: [
      ...
      f('material_id', 'materialId', 'fk', '物料(以副产物清单行为准)', {"filterable": true, "ref": {"resource": "invMaterials", "relation": "material", "labelField": "name"}, "readonly": true}),
      f('unit_id', 'unitId', 'fk', '单位(以副产物清单行为准)', {"filterable": true, "ref": {"resource": "basUnits", "relation": "unit", "labelField": "name"}, "readonly": true}),
