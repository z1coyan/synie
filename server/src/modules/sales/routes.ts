    ...
    .patch(
      ...
      async (c) => {
        ...
        const item = await defaults.update(c.get('actor'), c.req.valid('param').id, {
          ...
          deliveryDebitPresent: Object.prototype.hasOwnProperty.call(raw, 'deliveryDebitAccountId'),
          deliveryCreditAccountId: body.deliveryCreditAccountId,
          deliveryCreditPresent: Object.prototype.hasOwnProperty.call(
            raw,
            'deliveryCreditAccountId',
          ),
          receiptDebitAccountId: body.receiptDebitAccountId,
          receiptDebitPresent: Object.prototype.hasOwnProperty.call(raw, 'receiptDebitAccountId'),
          receiptCreditAccountId: body.receiptCreditAccountId,
          receiptCreditPresent: Object.prototype.hasOwnProperty.call(
            raw,
