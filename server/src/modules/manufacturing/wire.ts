...
export function demandWire(item: Demand) {
  return {
    ...
    assignType: upper(String(item.assignType)),
    needDate: item.needDate,
    remarks: item.remarks,
    status: upper(String(item.status)),
...
export function demandItemWire(item: DemandItem) {
  return {
    ...
    needDate: item.needDate,
    fulfillmentMethod: item.fulfillmentMethod ? upper(String(item.fulfillmentMethod)) : null,
    status: upper(String(item.status)),
