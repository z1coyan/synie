 ...
 */
import type { FormFieldMeta, FormMeta } from '@synie/shared'
 ...
 * 运行时返回 ResourceMeta；Registry 统一规范化并 seal。
 */
export function defineResourceMeta<const F extends readonly FieldMeta[]>(
  def: Omit<ResourceMeta, 'fields' | 'form'> & {
    fields: F
    form?: {
      exclude?: FieldNameOf<F>[]
      fields?: { [K in FieldNameOf<F>]?: FormFieldMeta }
