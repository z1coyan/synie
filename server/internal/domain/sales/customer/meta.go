...
const ResourceName = "salCustomers"

var auditedFields = []string{"code", "name", "short_name"}

func ResourceMeta() meta.ResourceMeta {
	destroy := "destroySalCustomer"
	return meta.ResourceMeta{
		Name: ResourceName, PermissionPrefix: "sales.customer",
		PermissionLabel: "客户", Table: "sal_customers",
		Fields: []meta.FieldMeta{
			{Name: "id", APIName: "id", DBColumn: "id", Type: meta.TypeUUID, Label: "id", Readonly: true, Sortable: true},
			{Name: "code", APIName: "code", DBColumn: "code", Type: meta.TypeString, Label: "客户编号", Required: true, Filterable: true, Sortable: true},
			{Name: "name", APIName: "name", DBColumn: "name", Type: meta.TypeString, Label: "客户名称", Required: true, Filterable: true, Sortable: true},
