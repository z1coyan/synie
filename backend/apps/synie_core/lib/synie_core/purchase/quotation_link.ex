defmodule SynieCore.Purchase.QuotationLink do
  @moduledoc """
  常规采购订单行↔采购报价条目的链接校验与梯度套价:行构建期派生(`OrderItem.DeriveQuotation`)
  ...
  (同 Sales.QuotationLink 先例)
  """

  require Ash.Query

  alias SynieCore.Purchase.{Quotation, QuotationItem, QuotationTier}
