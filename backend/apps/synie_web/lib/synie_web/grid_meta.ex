defmodule SynieWeb.GridMeta do
  ...
  @resources %{
    ...
    "purOrders" => SynieCore.Purchase.Order,
    "purOrderItems" => SynieCore.Purchase.OrderItem,
    "purOrderItemMaterials" => SynieCore.Purchase.OrderItemMaterial,
    "purOrderItemByproducts" => SynieCore.Purchase.OrderItemByproduct,
