...
const registry: Record<string, ResourceDrawerConfig> = {
  ...
  mfgWorkOrders: {
    ...
    fields: {
      ...
      needDate: { order: 6, cols: 6, edit: 'readOnly' },
      materialCode: { order: 7, cols: 6, edit: 'readOnly' },
      materialName: { order: 8, cols: 6, edit: 'readOnly' },
      materialSpec: { order: 9, cols: 6, edit: 'readOnly' },
      unitName: { order: 10, cols: 6, edit: 'readOnly' },
    },
  },
  mfgOutputs: {
    label: '生产入库单',
