...
import { purchaseReconciliationClient } from '~/lib/resources/reconciliations'
...
export const Route = createFileRoute(
  '/_app/scm/purchase-reconciliations/reconciliations',
)({
  component: ReconciliationsTab,
})

const GRID_OVERRIDES = {
  // 卡片:单号标题、供应商副标题、状态/本币合计/类型摘要
...
// 行操作按状态+类型出:草稿(编辑/删除/供应商确认[常规]/结单[赠送样品])、供应商已确认(撤回确认)、
...
function ReconciliationsTab() {
  ...
  // 供应商确认(常规)与结单审核(赠送/样品)都走「列出全部条目核对」的确认弹窗
