...
const RESOURCE_LABELS: Record<string, string> = {
  ...
  pur_supplier: '供应商',
  pur_quotation: '采购报价单',
  pur_quotation_item: '采购报价条目',
  pur_quotation_tier: '采购报价价格档',
  pur_order: '采购订单',
  pur_order_item: '采购订单条目',
  pur_order_item_material: '委外发料清单行',
  pur_order_item_byproduct: '委外副产物清单行',
  pur_receipt: '采购入库单',
  pur_receipt_item: '入库条目',
  pur_outsourced_issue: '委外发料单',
  pur_outsourced_issue_item: '委外发料条目',
  pur_outsourced_receipt: '委外入库单',
  pur_outsourced_receipt_item: '委外入库条目',
  pur_outsourced_receipt_item_material: '委外入库材料扣减行',
  pur_outsourced_receipt_item_byproduct: '委外入库副产物行',
  pur_reconciliation: '采购对账单',
  pur_reconciliation_item: '采购对账条目',
  hr_employee: '员工',
