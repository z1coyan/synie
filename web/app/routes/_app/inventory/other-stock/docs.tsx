...
import { StockDocPage, type StockDocConfig } from '../../scm/-stock-doc'
import { stockDocClient, stockDocItemClient } from '~/lib/resources/inventory'

export const Route = createFileRoute('/_app/inventory/other-stock/docs')({
...
const CFG: StockDocConfig = {
  ...
  docClient: stockDocClient,
  itemClient: stockDocItemClient,
