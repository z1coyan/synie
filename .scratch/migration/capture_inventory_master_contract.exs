defmodule CaptureInventoryMasterContract do
  @resources [
...
case System.argv() do
  [output_dir] ->
    CaptureInventoryMasterContract.run(output_dir)

  _ ->
    raise """
    usage:
      mix run .scratch/migration/capture_inventory_master_contract.exs OUTPUT_DIR
    """
end
