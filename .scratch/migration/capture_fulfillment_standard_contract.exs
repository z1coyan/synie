defmodule CaptureFulfillmentStandardContract do
  @resources [
...
case System.argv() do
  [output_dir] ->
    CaptureFulfillmentStandardContract.run(output_dir)

  _ ->
    raise """
    usage:
      mix run .scratch/migration/capture_fulfillment_standard_contract.exs OUTPUT_DIR
    """
end
