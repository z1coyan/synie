defmodule CapturePartyEmployeeContract do
  @resources [
...
case System.argv() do
  [output_dir] ->
    CapturePartyEmployeeContract.run(output_dir)

  _ ->
    raise """
    usage:
      mix run .scratch/migration/capture_party_employee_contract.exs OUTPUT_DIR
    """
end
